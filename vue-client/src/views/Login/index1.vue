<template>
  <div>
    ...
    <form @submit.prevent="handleSubmit" novalidate="true">
      ...
      <input type="email" name="customer.email" id="email" v-model="customer.email" />
      <input type="password" name="customer.password" id="password" v-model="customer.password" />
...
export default {
  setup() {
    ...
    const handleSubmit = () => {
      ...
      //   });
      // debugger;
      console.log(validations.customer.email.required.$invalid);
